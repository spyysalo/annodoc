...
// 		      function(a, b) { return b.replace(/\s+/g, ' '); });
    ...
    var createDocumentationLinks = function(collections) {
        // find anchors without href or id and turn these into 
	// links into the documentation.
        $('a:not([href]):not([id])').each(function(idx) {
    ...
    // TODO: rename, this does more than embed visualizations now
    var embedBratVisualizations = function(collectionData,
                                           documentCollections) {
